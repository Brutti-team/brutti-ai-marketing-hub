    ...
    <div className="page dashboard-page">
      ...
      <div className="dashboard-grid">
        ...
        <section className="panel focus-panel performance-dashboard-panel">
          ...
          <div className="guardrail-note"><Icon name="check"/><p><strong>{dashboardIdeas.length === 3 ? 'Data Meta disahkan' : 'Cadangan menunggu data Meta'}</strong> {dashboardIdeas.length === 3 ? 'Sumber: ' + dashboardIdeas[0].source : 'Sambungkan Meta dan tunggu sekurang-kurangnya satu post-level insight sebenar. Sistem tidak menggunakan fallback template atau KPI rekaan.'}<br/><small>Sync terakhir: {metaInsights?.sourceUpdatedAt ? new Date(metaInsights.sourceUpdatedAt).toLocaleString('ms-MY') : 'Belum ada'} · {metaInsights?.syncedPostCount || 0} post</small></p></div>
        </section>
      </div>
