...
assert(enhancer.includes(".settings-grid"), 'Language control is not isolated to Settings.')
...
console.log('PASS: App Language Lock persists BM/English choice, updates document language state, and stays isolated from Content Studio and Planner functional labels.')
